export default function TestingContent() {
  return (
    <div className="prose prose-lg max-w-none">
      <h2 className="text-3xl font-bold text-gray-800">Testing</h2>
      <p className="text-gray-600">
        Testing is a critical part of software development, ensuring that code works as intended and remains reliable as it evolves.  
        Mastering testing techniques helps you catch bugs early, improve code quality, and build user trust.
      </p>

      {/* INFO BOX */}
      <div className="p-4 border-l-4 border-blue-500 bg-blue-100 rounded">
        <h3 className="font-semibold text-blue-800">Why Testing?</h3>
        <p className="text-blue-700">
          Testing prevents regressions, documents expected behavior, and enables safe refactoring.  
          Automated tests are essential for continuous integration and delivery.
        </p>
      </div>
      ...
      {/* SECTION 4 */}
      <h3 className="text-2xl font-bold text-gray-800">4. Test Automation</h3>
      <ul>
...
`}
      ...
      <div className="p-4 border-l-4 border-green-500 bg-green-100 rounded">
        <h3 className="font-semibold text-green-800">Applications of Testing</h3>
