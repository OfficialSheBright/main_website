...
import { blockchainWeb3Config } from "@/lib/course-configs/blockchain-web3";
...
export default function BlockchainWeb3Course() {
  const [user, loading] = useAuthState(auth);
  const [enrolled, setEnrolled] = useState(false);
  const [currentTopicId, setCurrentTopicId] = useState("blockchain-basics");
  const [userProgress, setUserProgress] = useState<UserProgress | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  const courseConfig = blockchainWeb3Config;
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto py-12 px-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-yellow-600 to-amber-600 px-8 py-12 text-white">
            ...
            <div className="p-8">
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  className="bg-yellow-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-yellow-700 transition-colors shadow-lg"
                >
