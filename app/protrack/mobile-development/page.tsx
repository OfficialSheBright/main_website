...
import { mobileDevelopmentConfig } from "@/lib/course-configs/mobile-development";
...
export default function MobileDevelopmentCourse() {
  ...
  const [currentTopicId, setCurrentTopicId] = useState("mobile-basics");
  const [userProgress, setUserProgress] = useState<UserProgress | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  const courseConfig = mobileDevelopmentConfig;
