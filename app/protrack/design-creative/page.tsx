...
export default function DesignCreativeCourse() {
  ...
  const [currentTopicId, setCurrentTopicId] = useState("design-basics");
  const [userProgress, setUserProgress] = useState<UserProgress | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  const courseConfig = designCreativeConfig;
            ...
            <div className="p-8">
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  className="bg-pink-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-pink-700 transition-colors shadow-lg"
                >
