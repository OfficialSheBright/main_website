...
import { dataCloudConfig } from "@/lib/course-configs/data-cloud";
...
export default function DataCloudCourse() {
  const [user, loading] = useAuthState(auth);
  const [enrolled, setEnrolled] = useState(false);
  const [currentTopicId, setCurrentTopicId] = useState("data-basics");
  const [userProgress, setUserProgress] = useState<UserProgress | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  const courseConfig = dataCloudConfig;
      ...
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-sky-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-6 max-w-sm w-full text-center">
          ...
          <button 
            ...
            className="w-full bg-cyan-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-cyan-700 transition-colors"
          >
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto py-12 px-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-cyan-600 to-sky-600 px-8 py-12 text-white">
            ...
            <div className="p-8">
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  className="bg-cyan-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-cyan-700 transition-colors shadow-lg"
                >
