...
import { aiMLConfig } from "@/lib/course-configs/ai-ml";
...
export default function AIMLCourse() {
  ...
  const [currentTopicId, setCurrentTopicId] = useState("ai-basics");
  const [userProgress, setUserProgress] = useState<UserProgress | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  const courseConfig = aiMLConfig;
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-6 max-w-sm w-full text-center">
          ...
          <button 
            ...
            className="w-full bg-orange-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-orange-700 transition-colors"
          >
