...
export default function WebDevelopmentCourse() {
 // const router = useRouter();
  ...
  const {
    ...
    courseConfig: webDevelopmentConfig,
    initialTopicId: "html-basics" 
  });
  ...
  userProgress={currentEnrollment?.progress ? { ...currentEnrollment.progress, currentTopic: currentEnrollment.progress.currentTopic || "" } : null}
/>
      </div>
