...
import { productProjectConfig } from "@/lib/course-configs/product-project";
...
export default function ProductManagementCourse() {
  ...
  const [currentTopicId, setCurrentTopicId] = useState("product-basics");
  const [userProgress, setUserProgress] = useState<UserProgress | null>(null);
  const [isMobile, setIsMobile] = useState(false);

  const courseConfig = productProjectConfig;
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-6 max-w-sm w-full text-center">
          ...
          <button 
            ...
            className="w-full bg-teal-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-teal-700 transition-colors"
          >
            ...
            <div className="p-8">
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  className="bg-teal-600 text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-teal-700 transition-colors shadow-lg"
                >
