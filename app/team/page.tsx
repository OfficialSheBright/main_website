      ...
      <section className="max-w-7xl mx-auto px-4 py-8 sm:py-16">
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          <div className="grid lg:grid-cols-5 gap-0">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-[#ca5b8e] to-[#cc6594] p-6 sm:p-8 lg:p-12 flex flex-col justify-center text-white">
              <div className="max-w-md mx-auto lg:mx-0">
                ...
                <p className="text-base sm:text-lg leading-relaxed opacity-95 mb-4 sm:mb-6 text-center lg:text-left">
                  Behind every successful mission is a passionate team. Meet the innovators, builders, and visionaries who are transforming education and empowering communities across India.
                </p>
                <p className="text-sm sm:text-base opacity-90 text-center lg:text-left">
                  From strategic leadership to technical excellence, our diverse team brings together expertise, creativity, and a shared commitment to making quality education accessible to everyone.
                </p>
                <div className="mt-6 sm:mt-8 flex items-center justify-center lg:justify-start space-x-2">
              ...
              <div className="space-y-6 sm:space-y-8">
                {team.map((member, idx) => (
                  <div key={idx} className="group">
                    <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 p-4 sm:p-6 rounded-2xl hover:bg-gradient-to-r hover:from-[#fef0fc] hover:to-white transition-all duration-300 hover:shadow-lg">
                      {/* Image */}
                      <div className="flex-shrink-0">
                        <Image
                          ...
                          width={80}
                          height={80}
                          className="rounded-2xl border-3 border-[#ca5b8e]/20 shadow-md group-hover:border-[#ca5b8e]/40 transition-all duration-300 w-20 h-20 sm:w-20 sm:h-20"
                        />
                      </div>
                        ...
                        <div className="flex justify-center sm:justify-start space-x-3">
                          {member.social.linkedin && (
                            <a 
                              ...
                              className="w-8 h-8 bg-[#0077b5] text-white rounded-lg flex items-center justify-center hover:bg-[#005885] transition-colors duration-200"
                          ...
                          {member.social.twitter && (
                            <a 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="w-8 h-8 bg-[#1da1f2] text-white rounded-lg flex items-center justify-center hover:bg-[#0d8bd9] transition-colors duration-200"
                          ...
                          {member.social.github && (
                            <a 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="w-8 h-8 bg-[#333] text-white rounded-lg flex items-center justify-center hover:bg-[#24292e] transition-colors duration-200"
                          ...
                          {member.social.email && (
                            <a 
                              ...
                              className="w-8 h-8 bg-[#ca5b8e] text-white rounded-lg flex items-center justify-center hover:bg-[#b84c7a] transition-colors duration-200"
                    ...
                    {idx < team.length - 1 && (
                      <div className="mx-4 sm:mx-6 mt-4 sm:mt-6 h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent"></div>
                    )}
                  </div>
                ))}
              </div>
